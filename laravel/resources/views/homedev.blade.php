...
<body class="">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link " href="/dev/unit/prambanan">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link " href="/dev/unit/borobudur">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link " href="/dev/unit/ratuboko">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link " href="/dev/unit/tmii">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link " href="/dev/unit/manohara">
    ...
    <script>
        function jos(unit) {
            ...
            var tanggal = document.getElementById("exampleInputdate").value;

            window.location.href = '/dev/filter/' + unit + '/' + tanggal;
