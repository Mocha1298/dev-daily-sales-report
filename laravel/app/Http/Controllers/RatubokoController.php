...
class RatubokoController extends Controller
{
        ...
        // tabel pengguna jasa
            ...
            $target_pj = DB::connection("db_target")->select("
                ...
                (
                    ...
                    on y.id_unit = z.id
                    WHERE (x.thbl between left('".$date_start."',6) and left('".$date_end."',6)) and z.id = 3
                    group by y.id_link
                )x on w.id_link = x.id_link
                LEFT OUTER JOIN 
                (
                    ...
                    left outer join  new_master_unit z
                    on y.id_unit = z.id
                        WHERE x.tahun = left('".$date_end."',4) and z.id = 3
                    GROUP BY y.id_link
                )Y
        ...
        // tabel income
            ...
            $target_erp = DB::connection("db_target")->select("
                ...
                (
                    ...
                    left outer join  new_master_unit z
                    on y.id_unit = z.id
                    WHERE (x.thbl between left('".$date_start."',6) and left('".$date_end."',6)) and z.id = 3 and y.id_link = 4
                ...
                (
                    ...
                    left outer join  new_master_unit z
                    on y.id_unit = z.id
                    WHERE x.tahun = left('".$date_end."',4) and z.id = 3 and y.id_link = 4
                    GROUP BY y.id_link,x.target
                )Y
                ON x.id_link = y.id_link
